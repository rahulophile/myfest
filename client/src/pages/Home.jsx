          ...
          <div className="glass-card glass-accent rounded-2xl p-10">
            ...
            <div className="space-y-4 content-font text-white/85">
              <p>
                ...
                a convergence of ingenuity, experimentation, and collaboration.
                Across five days, we host interdisciplinary challenges including
                robotics races, autonomous navigation, embedded systems, AI
                sprint builds, web and app hackathons, CAD and structural design
                challenges, hardware prototyping, and a 4‑hour coding marathon.
              </p>
              <p>
                ...
                expert talks, and collaborate with creative minds from multiple
                domains — all within an atmosphere designed with immersive,
                future‑tech aesthetics.
              </p>
              <p>
                With cash prizes, recognition, mentorship, and networking
                opportunities, Vision Fest '25 is the ideal platform to showcase
                your skills and build something remarkable.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="glass-card rounded-2xl p-8 flex items-start gap-5">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/80 content-font text-lg leading-relaxed">
                  "Vision Fest embodies the spirit of engineering excellence and
                  curiosity. We welcome everyone to innovate, participate, and
                  inspire."
                </p>
              </div>
            </div>
